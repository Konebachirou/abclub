!(function (c) {
    ...
    (c.fn.showclock = function () {
        var n = new Date(),
            ...
            s = [0, 0];
        if (
            (null != c(this).data("time") &&
                (s = c(this).data("time").split(":")),
            (a =
        ...
        0 != t &&
            ...
            (n +=
                ...
                e(t) +
                "</span>"),
            (n += "<span class='countdown-heading days-top'>Jours</span>"),
            (n += "</div>")),
            ...
            (n +=
                ...
                e(o) +
                "</span>"),
            (n += "<span class='countdown-heading hours-top'>Heures</span>"),
            (n += "</div>"),
            ...
            (n +=
                ...
                e(s) +
                "</span>"),
            (n += "<span class='countdown-heading minutes-top'>Minutes</span>"),
            (n += "</div>"),
            ...
            (n +=
                ...
                e(a) +
                "</span>"),
            (n += "<span class='countdown-heading seconds-top'>Secondes</span>"),
            this.html((n += "</div>"));
    }),
