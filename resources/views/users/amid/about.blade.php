                ...
                <div class="col-md-12">
                    <div class="content text-start">
                        <div class="inner">
                            ...
                            <p class="description color-white">Mettre en place un terreau fertile et une source <br> d’appui au developpement d’initative africaines</p>
    ...
    <div class="container">
        <div class="row g-5 align-items-start">
            ...
            <div class="col-lg-10" data-sal="slide-up" data-sal-duration="500">
                <p class="mb--40 mb_sm--20">L'African Mobility and Innovation Day est un événement organisé par l'association
                    African Business Club, dédié à l'entrepreneuriat et au recrutement des jeunes diplômés en Afrique. Cet événement
                    se tient chaque année depuis sa création en 2015 et vise à promouvoir l'innovation et la mobilité en Afrique.
                    Pendant cette journée, des conférences inspirantes, des ateliers pratiques et des sessions de réseautage sont
                    organisés pour permettre aux jeunes entrepreneurs de développer leurs compétences et de rencontrer des
                    acteurs clés de l'industrie. L'événement met également en avant les opportunités professionnelles en
                    Afrique et encourage les jeunes diplômés à contribuer au développement économique du continent. L'African
                    Mobility and Innovation Day est devenu un rendez-vous incontournable pour les jeunes talents africains souhaitant
                ...
                <div class="rbt-default-tab">
                    <ul class="nav nav-tabs tab-button" role="tablist">
                        <li class="nav-item tabs__tab " role="presentation">
                            <button class="nav-link active" id="home-tab-5" data-bs-toggle="tab" data-bs-target="#home5" type="button" role="tab" aria-controls="home5" aria-selected="true">Leadership</button>
                        </li>
                        <li class="nav-item tabs__tab " role="presentation">
                            <button class="nav-link" id="profile-tab5" data-bs-toggle="tab" data-bs-target="#profile5" type="button" role="tab" aria-controls="profile5" aria-selected="false">Unité</button>
                        </li>
                        <li class="nav-item tabs__tab " role="presentation">
                            <button class="nav-link" id="contact-tab5" data-bs-toggle="tab" data-bs-target="#contact5" type="button" role="tab" aria-controls="contact5" aria-selected="false">Engagement</button>
                        </li>
                    </ul>
                    <div class="rainbow-tab-content tab-content">
                        <div class="tab-pane fade show active" id="home5" role="tabpanel" aria-labelledby="home-tab-5">
                            <p>Se positionner comme un intermédiaire entre des personnes désireuses de s’installer ou d’entreprendre en Afrique
                        ...
                        <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab5">
                            <ul>
                                <li>Construire un cercle de réflexion autour des questions/possibilités de contribution au développement de l'Afrique.
                                </li>
                                <li>
                                    Développer des partenariats sur le long terme avec les associations étudiantes, professionnelles, les entreprises et les cercles de réflexion.
                                </li>
                                <li>
                                    Développer un réseau fort et puissant et le mettre à disposition de nos adhérents et de nos sympathisants.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-pane fade" id="contact5" role="tabpanel" aria-labelledby="contact-tab5">
                            <ul>
                                <li>
                                    Promouvoir et renforcer le développement d'initiatives et les opportunités en Afrique.
                                </li>
                                <li>
            ...
            <div class="row mb--40">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        ...
                        <p class="description has-medium-font-size mt--20 mb--0">durant l'AMID dernier nous avons eu comme chiffre</p>
                    </div>
                </div>
            </div>
            <div class="row g-5">
