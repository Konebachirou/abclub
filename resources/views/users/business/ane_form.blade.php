                    ...
                    <form id="billing-form" action="{{ route('postuler-store') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12 mb--20">
                                ...
                                <input name="nom_projet_entreprise" type="text" required
                            ...
                            <div class="col-md-6 col-12 mb--20">
                                ...
                                <input name="date_naissance" required type="date"
                            ...
                            <div class="col-md-6 col-12 mb--20">
                                ...
                                <input name="numero_siren" type="text"
                            ...
                            <div class="col-md-6 col-12 mb--20">
                                ...
                                <input name="nom_depose_societe" type="text" placeholder="Nom déposé de la société">
                            ...
                            <div class="col-md-6 col-12 mb--20">
                                ...
                                <div class="rbt-modern-select  height-45">
                                    <select name="etes_vous_associe" required class="w-100">
                            ...
                            <div class="col-md-6 col-12 mb--20">
                                ...
                                <input type="text" name="segment_clients" required
                            ...
                            <div class="col-md-6 col-12 mb--20">
                                ...
                                <input type="text" name="proposition_valeur" required
                            ...
                            <div class="col-md-6 col-12 mb--20">
                                ...
                                <input type="text" name="structure_revenus" required
                                    placeholder="Structure de revenus *">
