                                ...
                                <div class="row g-5 row--30 align-items-center">
                                    ...
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                                            ...
                                            <h4 class="title"> <img src="{{ $pole->iconUrl() }}" alt="Shape Images" style="max-width: 60px;"> <span class="ml-4">{{ $pole->name }}</span></h4>
                                        </div>
                                        <div>
                                            {!! $pole->description !!}
                                        </div>
...
<!-- Start Video Area  -->
<div class="rbt-video-area" style="margin-top: 8%;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                ...
                <div class="rbt-card card-list-2 event-list-card variation-01 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        <ul class="rbt-meta">
                            ...
                            <li><span><i class="feather-calendar"></i>{{ date('d M \, Y', strtotime($event->start_date)) }}</span>
                                <span style="padding-left: 10px;"><i class="feather-clock"></i>{{ date('h:m ', strtotime($event->start_times)) }}
...
@endif
<!-- Start Blog Style -->
<div class="rbt-rbt-blog-area  bg-gradient-7 rbt-round-bottom-shape" style="margin-top: 10%;">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-02 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title elipses2"><a href="{{ route('news_details_link', $new->title) }}">{!! $new->title !!}</a>
                            </h5>
