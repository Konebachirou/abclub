        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-xl-4 col-xxl-4 col-md-6 col-sm-6 col-12">
                <div class="service-card service-card-5">
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modalPole-{{ $pole->id }}">
                        <div class="inner">
                            <div class="icon">
                                <img src="{{ asset('assets/images/shape/' . $pole->icon) }}" alt="Shape Images" style="max-width: 50px;">
                                <!-- <img src="assets/images/shape/icon-01.png" alt="Shape Images"> -->
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modalPole-{{ $pole->id }}">{{ $pole->name }}</a></h6>
            ...
            <div class="rbt-team-modal modal fade rbt-modal-default" id="modalPole-{{ $pole->id }}" tabindex="-1" aria-labelledby="modalPole-{{ $pole->id }}" aria-hidden="true">
                                ...
                                <div class="row g-5 row--30 align-items-center">
                                    ...
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                                            ...
                                            <h4 class="title"> <img src="{{ asset('assets/images/shape/' . $pole->icon) }}" alt="Shape Images" style="max-width: 60px;"> <span class="ml-4">{{ $pole->name }}</span></h4>
                                        </div>
                                        <div>
                                            {!! $pole->description !!}
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="pricing-right position-relative">
                                    <ul class="plan-offer-list">
                                        ...
                                        <li class="mt--20">
                                            <i class="feather-check"></i> Un accompagnement RH de qualité pour une insertion professionnelle rapide
                                        </li>
                                        <li class="mt--20">
                                            <i class="feather-check"></i> Des places VIP aux événements de l’ABC (AMID, M&amp;S),
                                        </li>
                                    </ul>
            ...
            <div class="row g-5 align-items-end mb--60">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="section-title text-start">
                        ...
                        <p class="description color-white-off mt--20">Tous savoir sur l'actualité de l'African Business Club. </p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="load-more-btn text-start text-lg-end">
                        <a class="rbt-btn btn-border icon-hover radius-round color-white-off" href="{{ route('news_link') }}">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-02 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title elipses2"><a href="{{ route('news_details_link', $new->title) }}">{!! $new->title !!}</a></h5>
                            <p class="rbt-card-text elipses3">{!!  $new->description !!}</p>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="{{ route('news_details_link', $new->title) }}">Lire Plus<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg">
...
<!-- ###############- MODALS -############## -->
<div class="rbt-team-modal modal fade rbt-modal-default" id="packModal" tabindex="-1" aria-labelledby="packModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="rbt-round-btn" data-bs-dismiss="modal" aria-label="Close">
