                    ...
                    <nav class="mainmenu-nav">
                        <ul class="mainmenu">
                            ...
                            <li class=" has-dropdown has-menu-child-item {{ $ongletActif === 'amid' ? 'active' : '' }}">
                                <a href="#">AMID</a>
                                <ul class="submenu">
                                    <li class=" has-menu-child-item position-static"><a href="{{ route('about_amid_link') }}">A propos de l'AMID</a></li>
                                ...
                                <div class="inner">
                                    <div class="rbt-admin-profile">
                                        <div class="admin-thumbnail">
                                            ...
                                            @else
                                            <img src="{{asset('assets/images/icons/avatar.png')}}" alt="User Images">
                                            @endif
...
<div class="popup-mobile-menu">
    <div class="inner-wrapper">
        <div class="inner-top">
            ...
            <p class="description" style="text-justify: inter-word;">L' ABC est la preuve vivante de l'efficacité d'une initiative volontariste et solidaire menée avec passion, intégrité et compétence.</p>
        ...
        <nav class="mainmenu-nav">
            <ul class="mainmenu">
                <li class="  {{ $ongletActif === 'accueil' ? 'active' : '' }}"><a href="{{ route('home_link') }}">Accueil </a></li>
                <li class=" has-dropdown has-menu-child-item {{ $ongletActif === 'about' ? 'active' : '' }}">
                    <a href="#">L'association</a>
                    <ul class="submenu">
                ...
                <li class=" {{ $ongletActif === 'news' ? 'active' : '' }}"><a href="{{ route('news_link') }}">News </a></li>
                <li class=" {{ $ongletActif === 'event' ? 'active' : '' }}"><a href="{{ route('event_link') }}">Events </a></li>
                <li class=" has-dropdown has-menu-child-item {{ $ongletActif === 'amid' ? 'active' : '' }}">
                    <a href="#">AMID</a>
                    <ul class="submenu">
                ...
                <li class="{{ $ongletActif === 'jobs' ? 'active' : '' }}"><a href="{{ route('jobs_link') }}">Jobs </a></li>
                ...
                <li class=" {{ $ongletActif === 'contact' ? 'active' : '' }}"><a href="{{ route('contact_link') }}">Contacts</a></li>
            </ul>
        </nav>
