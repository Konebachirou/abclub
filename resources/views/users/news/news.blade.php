...
<div class="rbt-section-overlayping-top rbt-section-gapBottom">
    <div class="container">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="rbt-blog-grid rbt-card variation-02 rbt-hover">
                                    ...
                                    <div class="rbt-card-body">
                                        <h5 class="rbt-card-title elipses2"><a href="{{ route('news_details_link', $report->title) }}">{{ $report->title }}</a>
                                        </h5>
                                        <ul class="blog-meta">
        ...
        overflow: hidden;">{!! $report->description !!}</div>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="rbt-blog-grid rbt-card variation-02 rbt-hover">
                                    ...
                                    <div class="rbt-card-body">
                                        <h5 class="rbt-card-title elipses2"><a href="{{ route('news_details_link', $reseau->title) }}">{{ $reseau->title }}</a>
                                        </h5>
                                        <ul class="blog-meta">

                                            <li><i class="feather-clock"></i>
                                                {{ date('d M \, Y', strtotime($reseau->created_at)) }}
                                            </li>
                                        </ul>
                                        <div class="description mt--30" style="display: -webkit-box;
        -webkit-line-clamp: 3;
        -webkit-box-orient: vertical;
        overflow: hidden;">{!! $reseau->description !!}</div>
                                        <!-- <p class="rbt-card-text elipses4">{!! $reseau->description !!}</p> -->
                                        <div class="rbt-card-bottom mt-3">
                                            <a class="transparent-button" href="{{ route('news_details_link', $reseau->title) }}">Lire
                                                Plus<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg">
                                                        <g stroke="#27374D" fill="none" fill-rule="evenodd">
                                                            <path d="M10.614 0l5.629 5.629-5.63 5.629" />
                                                            <path stroke-linecap="square" d="M.663 5.572h14.594" />
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="rbt-blog-grid rbt-card variation-02 rbt-hover">
                                    ...
                                    <div class="rbt-card-body">
                                        <h5 class="rbt-card-title elipses2"><a href="{{ route('news_details_link', $amid->title) }}">{{ $amid->title }}</a>
                                        </h5>
                                        <ul class="blog-meta">

                                            <li><i class="feather-clock"></i>
                                                {{ date('d M \, Y', strtotime($amid->created_at)) }}
                                            </li>
                                        </ul>
                                        <div class="description mt--30" style="display: -webkit-box;
        -webkit-line-clamp: 3;
        -webkit-box-orient: vertical;
        overflow: hidden;">{!! $amid->description !!}</div>
                                        <!-- <p class="rbt-card-text elipses4">{!! $amid->description !!}</p> -->
                                        <div class="rbt-card-bottom">
                                            <a class="transparent-button" href="{{ route('news_details_link', $amid->title) }}">Learn
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="rbt-blog-grid rbt-card variation-02 rbt-hover">
                                    ...
                                    <div class="rbt-card-body">
                                        <h5 class="rbt-card-title elipses2"><a href="{{ route('news_details_link', $nms->title) }}">{{ $nms->title }}</a>
                                        </h5>
                                        <ul class="blog-meta">
                                            <!-- -->
                                            <li><i class="feather-clock"></i>
                                                {{ date('d M \, Y', strtotime($nmss->created_at)) }}
                                            </li>
        ...
        -webkit-line-clamp: 3;
        -webkit-box-orient: vertical;
        overflow: hidden;">{!! $nms->description !!}</div>
                                        <!-- <p class="rbt-card-text elipses4">{!! $nms->description !!}</p> -->
                                        <div class="rbt-card-bottom">
                                            <a class="transparent-button" href="{{ route('news_details_link', $nms->title) }}">Learn
                                                More<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg">
                                                        <g stroke="#27374D" fill="none" fill-rule="evenodd">
                                                            <path d="M10.614 0l5.629 5.629-5.63 5.629" />
                                                            <path stroke-linecap="square" d="M.663 5.572h14.594" />
