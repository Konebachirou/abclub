                                ...
                                <div class="comment-inner">
                                    ...
                                    <div class="comment-meta">
                                        ...
                                        <div class="reply-edit">
                                            <div class="reply">
                                                <a class="comment-reply-link" href="#form-comment" onclick="document.getElementById('parent_id').value = {{ $comment->id }}">Répondre</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-comment">
                                        ...
                                        <div class="comment-inner">
                                            ...
                                            <div class="comment-meta">
                                                ...
                                                <div class="reply-edit">
                                                    <div class="reply">
                                                        <a class="comment-reply-link" href="#form-comment" onclick="document.getElementById('parent_id').value = {{ $comment->id }}">Reply</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="comment-text">
