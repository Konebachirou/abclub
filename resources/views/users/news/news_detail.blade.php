                                        ...
                                        <div class="comment-inner">
                                            ...
                                            <div class="comment-meta">
                                                <div class="time-spent">
                                                    {{ date('d M Y', strtotime($comment->created_at)) }} à
                                                    {{ date('h:m ', strtotime($comment->created_at)) }} </div>
                    ...
                    <div class="rbt-card card-list variation-02 rbt-hover mt--30">
                        <div class="rbt-card-img">
                            <a href="{{ route('news_details_link', $similar->title) }}">
                                <img src="{{ $similar->illustrationUrl() }}" alt="Card image"> </a>
                        </div>
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a
                                    href="{{ route('news_details_link', $similar->title) }}">{{ $similar->title }}</a>
                            </h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button"
                                    href="{{ route('news_details_link', $similar->title) }}">Lire
